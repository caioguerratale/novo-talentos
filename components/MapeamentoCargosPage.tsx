...
const documentoApresenta = [
    { titulo: 'Descrição e Atividades', icon: '📋', cor: 'from-red-500 to-red-600' },
    { titulo: 'Experiência e Formação', icon: '🎓', cor: 'from-blue-500 to-indigo-600' },
    { titulo: 'Conhecimentos Técnicos', icon: '💻', cor: 'from-emerald-500 to-teal-600' },
    { titulo: 'Soft Skills', icon: '🤝', cor: 'from-amber-500 to-orange-600' },
    { titulo: 'Ambiente de Trabalho', icon: '🏢', cor: 'from-purple-500 to-violet-600' },
    { titulo: 'Níveis de Autoridade', icon: '📊', cor: 'from-sky-500 to-blue-600' },
];
