                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
                        <div>
                            ...
                            <p className="text-xl text-white/80 mb-8 leading-relaxed">
                                Quer saber como a gente poderia ajudar a sua empresa? Preencha o formulário e <strong className="text-white">nós entraremos em contato em breve</strong>.
                            </p>
                            ...
                            <div className="space-y-4 mb-8">
                                ...
                                <div className="flex items-center gap-3 text-white/90">
                                    ...
                                    <span>Vagas em todos os níveis hierárquicos</span>
                                </div>
                                <div className="flex items-center gap-3 text-white/90">
                                    <svg className="w-5 h-5 text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                            ...
                            <form onSubmit={handleSubmit} className="space-y-5">
                                ...
                                <div>
                                    ...
                                    <select
                                        ...
                                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-200 outline-none bg-white"
                                    >
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-all duration-200 outline-none resize-none"
                                        placeholder="Descreva sua necessidade de recrutamento..."
                                    ></textarea>
                                </div>
